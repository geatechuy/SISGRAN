...
usuarioWeb.addEventListener('click', function(){
    ...
    usuarioWeb.classList.add('activo');
    usuarioEmpresa.classList.remove('activo');
    usuarioHuerta.classList.remove('activo');
});
...
usuarioEmpresa.addEventListener('click', function(){
    ...
    usuarioWeb.classList.remove('activo');
    usuarioEmpresa.classList.add('activo');
    usuarioHuerta.classList.remove('activo');
});
...
usuarioHuerta.addEventListener('click', function(){
    ...
    usuarioWeb.classList.remove('activo');
    usuarioEmpresa.classList.remove('activo');
    usuarioHuerta.classList.add('activo');
});